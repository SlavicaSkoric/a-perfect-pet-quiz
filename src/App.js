...
class App extends React.Component {
  ...
  scramble() {
    ...
    this.setState({scrambledqone: this.state.qone.split('').sort(function(){return 0.5-Math.random()}).join('')});
    this.setState({scrambledqtwo: this.state.qtwo.split('').sort(function(){return 0.5-Math.random()}).join('')});
    this.setState({scrambledqthree: this.state.qthree.split('').sort(function(){return 0.5-Math.random()}).join('')});
  ...
  retrytest() {
    this.setState({qone: "", qtwo: "", qthree: "", petname: "", scrambledqone: "", scrambledqtwo: "", scrambledqthree: ""});
  ...
  render() {
    ...
    return (
      ...
      <div id="app" className="app d-flex align-items-center justify-content-center vh-100">
        ...
        <div id="quiz" className="col-6 box p-5">
          ...
          <div id="container" className="d-flex justify-content-center">
            ...
            <div id="q1" style={{display: "none"}}>
              ...
              <div className="d-flex flex-column">
                <Button color="primary" id="q1a" className="m-2" onClick={() => this.saveanswerq1("q1a")}>1) Small</Button>
                <Button color="primary" id="q1b" className="m-2" onClick={() => this.saveanswerq1("q1b")}>2) Big</Button>
                <Button color="primary" id="q1c" className="m-2" onClick={() => this.saveanswerq1("q1c")}>3) Medium-sized</Button>
                <Button color="primary" id="q1d" className="m-2" onClick={() => this.saveanswerq1("q1d")}>4) Extra large</Button>
              </div>
            </div>
            ...
            <div id="q2" style={{display: "none"}}>
              ...
              <div className="d-flex flex-column">
                <Button color="primary" id="q2a" className="m-2" onClick={() => this.saveanswerq2("q2a")}>1) Eat a lot</Button>
                <Button color="primary" id="q2b" className="m-2" onClick={() => this.saveanswerq2("q2b")}>2) Run a lot</Button>
                <Button color="primary" id="q2c" className="m-2" onClick={() => this.saveanswerq2("q2c")}>3) Play a lot</Button>
                <Button color="primary" id="q2d" className="m-2" onClick={() => this.saveanswerq2("q2d")}>4) Sleep a lot</Button>
              </div>
            </div>
            ...
            <div id="q3" style={{display: "none"}}>
              ...
              <div className="d-flex flex-column">
                <Button color="primary" id="q3a" className="m-2" onClick={() => this.saveanswerq3("q3a")}>1) Hot weather</Button>
                <Button color="primary" id="q3b" className="m-2" onClick={() => this.saveanswerq3("q3b")}>2) Cold weather</Button>
                <Button color="primary" id="q3c" className="m-2" onClick={() => this.saveanswerq3("q3c")}>3) Indoors</Button>
                <Button color="primary" id="q3d" className="m-2" onClick={() => this.saveanswerq3("q3d")}>4) Outdoors</Button>
              </div>
            </div>
            ...
            <div className="d-flex flex-column">
              ...
              <h2 id="resultrandomized" style={{display: "none"}}>My pet is {values.q1[Math.floor(Math.random() * values.q1.length)]}, and although he likes to {values.q2[Math.floor(Math.random() * values.q2.length)]}, he really hates {values.q3[Math.floor(Math.random() * values.q3.length)]}.</h2>
              <h2 id="result" style={{display: "none"}}>My pet is {this.state.qone}, and although he likes to {this.state.qtwo}, he really hates {this.state.qthree}.</h2>
              <h2 id="resultscrambled" style={{display: "none"}}>My pet is {this.state.scrambledqone}, and although he likes to {this.state.scrambledqtwo}, he really hates {this.state.scrambledqthree}.</h2>
              ...
              <Button color="secondary" id="scramble" className="m-2" style={{display: "none"}} onClick={() => this.scramble()}>Scramble</Button>
              <Button color="primary" id="reset" className="m-2" style={{display: "none"}} onClick={() => this.reset()}>Reset</Button>
              <Button color="success" id="retrytest" className="m-2" style={{display: "none"}} onClick={() => this.retrytest()}>Retry test</Button>
            </div>          
          </div>
        </div>
      </div>
